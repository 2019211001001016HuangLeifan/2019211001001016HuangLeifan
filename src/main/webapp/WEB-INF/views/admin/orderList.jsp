			...
			<div class="table-responsive col-sm-10">
				...
				<thead>
					...
					<c:forEach var="o" items="${orderList}">
						...
						<td>${o.orderDate}</td>
						<%
							com.dabin.model.Order o=(com.dabin.model.Order)pageContext.findAttribute("o");
							int userId=o.getCustomerId();
							java.sql.Connection con=(java.sql.Connection)application.getAttribute("con");
							com.dabin.dao.UserDao userDao=new com.dabin.dao.UserDao();
						...
						<td class="cart_total"><td><%=customerName %></td>
							<td>
						...
						<%
							...
							String paymentType=com.dabin.model.Payment.findByPaymentId(con,n);
							 %>
